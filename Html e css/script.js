...
// URL do seu back-end no Railway (substitua pela sua URL)
const backendURL = "https://backend-production-ea07.up.railway.app";
...
Carga: ${carga}
Data/Hora: ${datahora}`;
      const numero = "5551989437457"; // substitua pelo seu número
